...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    entities: _entities,
    lastEntityId: const obx_int.IdUid(6, 6612935997316587887),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ...
    SummaryEntity: obx_int.EntityDefinition<SummaryEntity>(
      ...
      objectFromFB: (obx.Store store, ByteData fbData) {
        ...
        final isMeetingParam = const fb.BoolReader().vTableGet(
          buffer,
          rootOffset,
          18,
          false,
        ...
        final startTimeParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          12,
          0,
        );
        final endTimeParam = const fb.Int64Reader().vTableGet(
          buffer,
          rootOffset,
          14,
          0,
...
class LlmConfigEntity_ {
  ...
  static final id = obx.QueryIntegerProperty<LlmConfigEntity>(
    _entities[0].properties[0],
  );

  /// See [LlmConfigEntity.provider].
  static final provider = obx.QueryStringProperty<LlmConfigEntity>(
    _entities[0].properties[1],
  );

  /// See [LlmConfigEntity.model].
  static final model = obx.QueryStringProperty<LlmConfigEntity>(
    _entities[0].properties[2],
  );

  /// See [LlmConfigEntity.apiKey].
  static final apiKey = obx.QueryStringProperty<LlmConfigEntity>(
    _entities[0].properties[3],
  );

  /// See [LlmConfigEntity.baseUrl].
  static final baseUrl = obx.QueryStringProperty<LlmConfigEntity>(
...
class RecordEntity_ {
  /// See [RecordEntity.id].
  static final id = obx.QueryIntegerProperty<RecordEntity>(
    _entities[1].properties[0],
  );

  /// See [RecordEntity.role].
  static final role = obx.QueryStringProperty<RecordEntity>(
    _entities[1].properties[1],
  );

  /// See [RecordEntity.content].
  static final content = obx.QueryStringProperty<RecordEntity>(
    _entities[1].properties[2],
  );

  /// See [RecordEntity.category].
  static final category = obx.QueryStringProperty<RecordEntity>(
    _entities[1].properties[3],
  );

  /// See [RecordEntity.vector].
  static final vector = obx.QueryHnswProperty<RecordEntity>(
    _entities[1].properties[4],
  );

  /// See [RecordEntity.createdAt].
  static final createdAt = obx.QueryIntegerProperty<RecordEntity>(
...
class SummaryEntity_ {
  ...
  static final id = obx.QueryIntegerProperty<SummaryEntity>(
    _entities[2].properties[0],
  );

  /// See [SummaryEntity.subject].
  static final subject = obx.QueryStringProperty<SummaryEntity>(
    _entities[2].properties[1],
  );

  /// See [SummaryEntity.content].
  static final content = obx.QueryStringProperty<SummaryEntity>(
    _entities[2].properties[2],
  );

  /// See [SummaryEntity.vector].
  static final vector = obx.QueryHnswProperty<SummaryEntity>(
    _entities[2].properties[3],
  );

  /// See [SummaryEntity.startTime].
  static final startTime = obx.QueryIntegerProperty<SummaryEntity>(
    _entities[2].properties[4],
  );

  /// See [SummaryEntity.endTime].
  static final endTime = obx.QueryIntegerProperty<SummaryEntity>(
    _entities[2].properties[5],
  );

  /// See [SummaryEntity.createdAt].
  static final createdAt = obx.QueryIntegerProperty<SummaryEntity>(
    _entities[2].properties[6],
  );

  /// See [SummaryEntity.isMeeting].
  static final isMeeting = obx.QueryBooleanProperty<SummaryEntity>(
    _entities[2].properties[7],
  );

  /// See [SummaryEntity.audioPath].
  static final audioPath = obx.QueryStringProperty<SummaryEntity>(
    _entities[2].properties[8],
  );

  /// See [SummaryEntity.title].
  static final title = obx.QueryStringProperty<SummaryEntity>(
