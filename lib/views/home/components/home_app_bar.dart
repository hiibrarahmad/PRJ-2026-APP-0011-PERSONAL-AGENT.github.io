    ...
    return Row(
      children: [
        InkWell(
          ...
          onTap: onTapLogo,
          child: BudIcon(icon: AssetsUtil.icon_chat_logo, size: 26.sp),
        ),
        SizedBox(width: 4.sp),
        Expanded(
          child: Text(
        ...
        InkWell(
          ...
          child: BudIcon(
            icon: bluetoothConnected == BluetoothConnectionState.connected
        ...
        InkWell(
          ...
          child: BudIcon(icon: AssetsUtil.icon_btn_setting, size: 26.sp),
        ),
      ],
    );
  }
