...
class AssetsUtil {
  ...
  static const String icon_login_wechat = 'icon_login_wechat.png';
  static const String icon_select_on = 'icon_select_on.png';
  static const String icon_select_off = 'icon_select_off.png';

  static String getIconPath({Mode mode = Mode.light, required String icon}) {
    return mode == Mode.light
        ? '$prefixIconPath/light/$icon'
        : '$prefixIconPath/dark/$icon';
  }

  static String getImagePath({Mode mode = Mode.light, required String image}) {
    return mode == Mode.light
