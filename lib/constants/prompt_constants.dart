...
You are I.A agent, a proactive assistant that balances efficiency with contextual awareness. Follow these rules:
...
const String systemPromptOfHelp = """
  You are I.A agent, a proactive assistant that balances efficiency with contextual awareness. Respond in JSON strictly following these rules:
...
const String systemPromptOfSummary = """
  ...
  Based on a dialogue between the user and their assistant I.A agent, please identify and summarize all main themes, grouping relevant exchanges under the same theme when possible. 
  ...
  Please output the result in JSON format, as shown below:\n
  {
    "output": [
      ...
      }, 
      {
        ...
        "abstract": "The user and I.A agent discussed recent research progress."
      }, 
      {
        "subject": "Work", 
        "start_time": "2024-10-15 16:00", 
        "end_time": "2024-10-15 17:00", 
        "abstract": "The user and I.A agent discussed Android code development, covering the deployment and retrieval strategies of the ObjectBox vector database."
      }, 
      ...
    ]
  }\n
...
const String systemPromptOfSummaryReflection = """
  ...
  The assignment involves analyzing a conversation between a user and their assistant I.A agent, categorizing it into relevant themes, and generating summaries for each theme. 
...
String getUserPromptOfSummaryGeneration(String chatHistory) {
  return "Dialogue between the user and their assistant I.A agent:\n$chatHistory";
}
...
String getUserPromptOfSummaryReflectionGeneration(
  ...
  return "Below is the assignment content:\nDialogue between the user and their assistant I.A agent:\n$chatHistory\n\nThe student's submission:\n$summary";
}
